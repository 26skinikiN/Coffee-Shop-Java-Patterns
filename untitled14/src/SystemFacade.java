...
public class SystemFacade {
    ...
    public SystemFacade(ArrayList<User> accountList, ArrayList<Coffee> coffeeArrayList, String filename, String filecomputer) {
        userManager = new UserManager(accountList);
        adminManager = new AdminManager(coffeeArrayList, accountList, filename, filecomputer);
    }
    ...
    public void performAdminOperations(ArrayList<User> accountList, String filename) {
        try {
            ...
            System.out.println("4 - Забанить пользователя");
            System.out.println("5 - Разбанить пользователя");
